...
<img src="bank.png" height=65% width=30% alt="Welcome to the sparks bank!" style="padding: 5px; margin-right: 8vw; margin-top:8vh; float:right"> 
  ...
  <div class="contentbox">
    ...
    <h1> ABOUT US</h1>
    <img src="developer.jpg" alt="Developer Profile" width="20%" height="30%" style="  border-radius: 10px;
      border-style: double; display: block; margin: 5px;">
      <h4> This website is created by</h4>
      <h2 style="font-family: Verdana"><u> VEMULA PALLAVI </u></h2>
      <h4> Intern at Sparks Foundation <br> </h4>
...
Banking System ,Bangalore,India
</center>
</div>
</center>
  </body>
